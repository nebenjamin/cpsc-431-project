...
namespace FunctionParser
{
    public class Parser
    {
        ...
        public string Parse(string Cell_Number, string Cell_String) //NOT COMPLETE YET
        {
            Base_Cell = Cell_Number;
            Base_String = Cell_String;
        ...
        private ArrayList Reformat(ArrayList Parts) //NOT COMPLETE YET (Cell Reference,A1 or even PI)
        {
