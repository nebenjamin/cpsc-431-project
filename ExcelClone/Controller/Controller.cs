	...
	class Controller
	{
		...
		private void ExecuteDeleteActiveWS()
		{
			...
			try
			{
				...
				if (mainForm.WorksheetsTabControl.TabCount == 0)
				{
					ExecuteInsertWorksheet();
				}
			}
		...
		public void ExecuteAbout()
		{
			MessageBox.Show("Excel Clone, Class Project for CPSC-431: Software Engineering\n" +
											"Professor: \n    William M. Lively\n" +
											"Creators: \n" +
											"    User Interface: \n\tEmory Cook, Long Mai, Michael Johnson\n" +
											"    Functions: \n\tCaleb Wells, David Brown, Tyler Hennings, Chris Garcia\n" +
											"    I/O & Formatting: \n\tChris Smith, Scott Pompeo, Gabriel Terrel, Nathan Benjamin\n" +
											"    Graphing: \n\tNathan Sullivan, Andrew Menard, David Moreno\n" +
											"Available Functions:\n" +
											"    ADD, SUB, MUL, DIV, AVG, MAX, MIN, COUNT, ABS, LOG10, LOG, LN," +
											" ROUND,\n    COS, SIN, TAN, POW, SQRT, DEGREES, RADIANS, PI", "About Excel Clone");
		}
